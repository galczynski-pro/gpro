                ...
                <div class="card-flip-inner">
                  ...
                  <div class="card-face card-front">
                    ...
                    <div class="card-ai-image">
                      ...
                      <a href="<?php echo $base_url; ?>/chat/<?php echo $showPrompts->slug; ?>"><img loading="lazy"  src="<?php echo $base_url; ?>/public_uploads/<?php echo $showPrompts->image; ?>" onerror="this.src='<?php echo $base_url; ?>/img/no-image.svg'" alt="<?php echo $showPrompts->name; ?>" title="<?php echo $showPrompts->name; ?>"></a>
                    </div>
                  ...
                  <div class="card-face card-back">
                    <div class="card-back-body">
                      ...
                      <?php if (!empty($showPrompts->description) && $showPrompts->display_description) { ?>
                        <div class="small pre-line"><?php echo truncateText(strip_tags($showPrompts->description), 180); ?></div>
                      <?php } ?>
                      <?php if ($showPrompts->display_API_MODEL && !empty($showPrompts->API_MODEL)) { ?>
